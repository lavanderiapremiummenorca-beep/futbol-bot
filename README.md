# 🤖 Futbol en Datos — Shorts automaticos y gratis

Genera y publica un Short de curiosidades de futbol al dia en YouTube, en automatico y sin pagar suscripciones.
...
3. El workflow `.github/workflows/daily.yml` hace las dos cosas cada dia (~19:19 Espana).
...
- `YT_CLIENT_SECRET`
- `YT_REFRESH_TOKEN`
- `CHANNEL_HANDLE` — tu @handle para la marca de agua (ej. `@FutbolEnDatos`)
